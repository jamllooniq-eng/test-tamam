...
export const ProductGallery: React.FC<ProductGalleryProps> = ({
  ...
  // Process horizontal swipe gesture — UNCHANGED from original: swipe right -> next
  ...
  return (
    <div id="product-gallery" className="w-full max-w-[480px] mx-auto select-none">
      ...
      >
        ...
        {/* Product Image Stage - single stable element, src swaps in place instead of remounting (smoother than before) */}
        {proxiedActiveImage ? (
          <img
            ref={(node) => {
